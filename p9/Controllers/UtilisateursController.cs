...
namespace p9.Controllers
{
    public class UtilisateursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Role,Pw")] Utilisateur utilisateur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Role,Pw")] Utilisateur utilisateur)
        {
